...
const STYLES = `
.mrd-pr-wrapper{display:flex;flex-direction:column;gap:8px;width:100%;height:100%;box-sizing:border-box;padding-bottom:4px}
...
.mrd-pr-gap-menu-btn{background:#2a2a2a;color:#e0e0e0;border:1px solid #333;border-radius:4px;padding:6px 14px;font-size:11px;cursor:pointer;text-align:left;white-space:nowrap;display:flex;align-items:center;gap:6px;transition:background 0.15s ease}
...
.mrd-pr-segment-bounds{font-size:12px;color:#aaa;user-select:none;-webkit-user-select:none}
.mrd-pr-timecode{font-size:14px;font-weight:bold;color:#e0e0e0;user-select:none;-webkit-user-select:none}
...
.mrd-pr-settings-input{background:transparent;color:#e0e0e0;border:none;padding:0 4px;font-size:12px;width:50px;height:22px;text-align:center;outline:none;-moz-appearance:textfield}
...
.tr-gp-input{background:#222;color:#e0e0e0;border:1px solid #3a3a3a;border-radius:4px;padding:3px 6px;font-size:11px;width:100%;box-sizing:border-box;outline:none;transition:border-color 0.15s ease}
...
.tr-out-input{background:#222;color:#e0e0e0;border:1px solid #3a3a3a;border-radius:4px;padding:3px 6px;font-size:11px;width:100%;box-sizing:border-box;outline:none;transition:border-color 0.15s ease}
